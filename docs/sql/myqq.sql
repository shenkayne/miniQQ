...
insert  into `GetPwdInfo`(`gqq`,`question`,`answer`,`qq`) values
(1,0,'周雨桐',10002),(2,4,'周雨桐',10002),(3,8,'周雨桐',10002),
(13,0,'陈一诺',10003),(14,4,'陈一诺',10003),(15,8,'陈一诺',10003),
(16,0,'刘星辰',10004),(17,4,'刘星辰',10004),(18,8,'刘星辰',10004),
(19,0,'王梓涵',10005),(20,4,'王梓涵',10005),(21,8,'王梓涵',10005),
(22,0,'张可欣',10006),(23,4,'张可欣',10006),(24,8,'张可欣',10006),
(25,1,'李沐阳',10007),(26,4,'李沐阳',10007),(27,8,'李沐阳',10007),
(28,2,'赵清雅',10008),(29,6,'赵清雅',10008),(30,11,'赵清雅',10008);
...
CREATE TABLE `Text` (
  ...
  `tcontext` varchar(200) CHARACTER SET utf8mb4 DEFAULT NULL,
  `tfonttype` varchar(10) DEFAULT NULL,
  `tfontsize` int(5) DEFAULT NULL,
  `tfontcolor` varchar(50) CHARACTER SET utf8mb4 DEFAULT NULL,
...
insert  into `Text`(`tno`,`tcontext`,`tfonttype`,`tfontsize`,`tfontcolor`,`isBold`,`isItatic`,`isUnderline`) values (10,'52435','楷体',14,'0*0*255',1,0,0),(11,'3454','楷体',14,'0*0*255',1,0,0),(12,'4','楷体',14,'0*0*255',1,0,0),(13,'45345','楷体',14,'0*0*255',1,0,0),(14,'43534','楷体',14,'0*0*255',1,0,0),(15,'5424','楷体',14,'0*0*255',1,0,0),(16,'254','楷体',14,'0*0*255',1,0,0),(17,'54335','楷体',14,'0*0*255',1,0,0),(18,'43545','楷体',14,'0*0*255',1,0,0),(19,'43534','楷体',14,'0*0*255',1,0,0),(20,'4','楷体',14,'0*0*255',1,0,0),(21,'543','楷体',14,'0*0*255',1,0,0),(22,'453','楷体',14,'0*0*255',1,0,0),(23,'534453','楷体',14,'0*0*255',1,0,0),(24,'53444','楷体',14,'0*0*255',1,0,0),(25,'4254','楷体',14,'0*0*255',1,0,0),(26,'2542345','楷体',14,'0*0*255',1,0,0),(27,'254','楷体',14,'0*0*255',1,0,0),(28,'5434','楷体',14,'0*0*255',1,0,0),(29,'5252','楷体',14,'0*0*255',1,0,0),(30,'41421','楷体',14,'0*0*255',1,0,0),(31,'25324','楷体',14,'0*0*255',1,0,0),(32,'25234','楷体',14,'0*0*255',1,0,0),(33,'254','楷体',14,'0*0*255',1,0,0),(34,'535','楷体',14,'0*0*255',1,0,0),(35,'12315','楷体',14,'0*0*255',1,0,0),(36,'212315314','楷体',14,'0*0*255',1,0,0),(37,'541531','楷体',14,'0*0*255',1,0,0),(38,'54531','楷体',14,'0*0*255',1,0,0),(39,'4545634','楷体',14,'0*0*255',1,0,0),(40,'53156','楷体',14,'0*0*255',1,0,0),(41,'466534','楷体',14,'0*0*255',1,0,0),(42,'15313','楷体',14,'0*0*255',1,0,0),(43,'485413','楷体',14,'0*0*255',1,0,0),(44,'153415','楷体',14,'0*0*255',1,0,0),(45,'15153','楷体',14,'0*0*255',1,0,0),(46,'35153','楷体',14,'0*0*255',1,0,0),(47,'45153','楷体',14,'0*0*255',1,0,0),(48,'text-48','楷体',14,'0*0*255',1,0,0),(49,'5135','楷体',14,'0*0*255',1,0,0),(50,'4241534','楷体',14,'0*0*255',1,0,0),(51,'15346','楷体',14,'0*0*255',1,0,0),(52,'456456','楷体',14,'0*0*255',1,0,0),(53,'45345','楷体',14,'0*0*255',1,0,0),(54,'435456','楷体',14,'0*0*255',1,0,0),(55,'545341356','楷体',14,'0*0*255',1,0,0),(56,'413515','楷体',14,'0*0*255',1,0,0),(57,'45645','楷体',14,'0*0*255',1,0,0),(58,'454634','楷体',14,'0*0*255',1,0,0),(59,'4545634','楷体',14,'0*0*255',1,0,0);
...
CREATE TABLE `UserInfo` (
  ...
  `sign` varchar(30) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '签名',
  `photoID` int(2) NOT NULL COMMENT '头像id',
  `nickname` varchar(10) CHARACTER SET utf8mb4 NOT NULL COMMENT '昵称',
  `sex` char(2) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '性别',
  `birthday` date DEFAULT NULL COMMENT '生日',
  `telephone` varchar(15) CHARACTER SET utf8mb4 DEFAULT NULL COMMENT '手机号',
...
insert  into `UserInfo`(`qq`,`pwd`,`sign`,`photoID`,`nickname`,`sex`,`birthday`,`telephone`,`email`,`address`) values
(10001,'123','林子轩',2,'林子轩','男',NULL,'138000010001','u10001@example.com','地址占位'),
(10002,'123','周雨桐',1,'周雨桐','男','1992-03-16','138000010002','u10002@example.com','地址占位'),
(10003,'123','陈一诺',1,'陈一诺','男','2002-07-01','138000010003','u10003@example.com','地址占位'),
(10004,'123','刘星辰',1,'刘星辰','男','2010-12-31','138000010004','u10004@example.com','地址占位'),
(10005,'123','王梓涵',1,'王梓涵','男','2013-12-31','138000010005','u10005@example.com','地址占位'),
(10006,'123','张可欣',1,'张可欣','男','2013-12-31','138000010006','u10006@example.com','地址占位'),
(10007,'123','李沐阳',4,'李沐阳','男','2011-06-03','138000010007','u10007@example.com','地址占位'),
(10008,'123','赵清雅',1,'赵清雅','男','2002-06-05','138000010008','u10008@example.com','地址占位');
